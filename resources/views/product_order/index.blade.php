...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-header">
            ...
            <a href="{{ route('exportPDF.productOrderAll') }}" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Export PDF</a>
            <a href="{{ route('exportExcel.productOrderAll') }}" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Export Excel</a>
        </div>
    ...
    <div class="box box-success col-md-6">
        ...
        {{--<div class="box-header">--}}
            ...
            {{--<a href="{{ route('exportExcel.productOrderAll') }}" class="btn btn-success">Export Excel</a>--}}
        {{--</div>--}}
            ...
            <table id="invoice" class="table table-bordered table-hover table-striped">
                ...
                @foreach($invoice_data as $i)
                    <tbody>
                        ...
                        <td>{{ $i->tanggal }}</td>
                        <td>
                            <a href="{{ route('exportPDF.productOrder', [ 'id' => $i->id ]) }}" class="btn btn-sm btn-danger">Export Invoice</a>
                        </td>
                    </tbody>
                @endforeach
            </table>
...
@section('bot')
    ...
    processing: true,
    serverSide: false, // Yajra-ს გარეშე აუცილებლად false
