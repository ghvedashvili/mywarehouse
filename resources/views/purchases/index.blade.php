...
$(function() {
    ...
    var returnsInTransitTable = $('#returns-intransit-table').DataTable({
        ...
        columns: [
            ...
            { data: 'status_name',     name: 'status_name',     orderable: false, responsivePriority: 6, className: 'pu-td-status' },
            { data: 'created_at',      name: 'created_at',      responsivePriority: 9, className: 'pu-td-date' },
            { data: 'responsible_select',       name: 'responsible_select',       orderable: false, responsivePriority: 8, visible: isAdmin, className: 'pu-td-hide' },
            { data: 'cancelled_comment_html',   name: 'cancelled_comment_html',   orderable: false, responsivePriority: 8, visible: isAdmin, className: 'pu-td-hide text-center' },
            { data: 'action',          name: 'action',          orderable: false, responsivePriority: 2, className: 'pu-td-action' },
            { data: 'is_return_purchase', visible: false },
            { data: 'group_items_json',   visible: false },
        ],
