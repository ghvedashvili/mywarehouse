...
@section('bot')
    ...
    <script type="text/javascript">
        ...
        function editForm(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#tel').val(data.tel);
                    $('#alternative_tel').val(data.alternative_tel);
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        success: function(data) {
                            table.ajax.reload();
                            swal("Deleted!", "მომხმარებელი წარმატებით წაიშალა", "success");
                        },
                        error: function() {
                            swal("Error", "წაშლისას დაფიქსირდა შეცდომა", "error");
                        }
                    });
                }
            });
        ...
        // 5. შენახვის/განახლების ლოგიკა (Submit)
        $(function() {
